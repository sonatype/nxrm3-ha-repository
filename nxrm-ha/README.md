...
* [External secret operator](https://external-secrets.io/latest/): recommended as it supports several external secret stores (AWS, Azure, GCP etc).
  * Irrespective of whether you're installing on AWS/Azure, the following steps are needed to configure the nxrm-ha helm chart to use the External Secrets Operator:
    ...
    - In your values.yaml:
        ...
        - Set the `externalsecrets.secrets.database.valueIsJson` to true, if Secrets are created as Key-Value Pair.
        ...
        - Set the `externalsecrets.secrets.admin.valueIsJson` to true, if Secret is created as Key-Value Pair.        
        ...
        - Set the `externalsecrets.secrets.license.valueIsJson` to true, if Secret is created as Key-Value Pair. (for E.g in HashCorp Vault)         
        - Set the `externalsecrets.secrets.license.licenseKey` to the name of the key in the secret containing your Nexus Repository license in your external secret store. E.g. if using HashiCorp Vault, this should be the name of the key in the secret which contains your license.
...
| `externalsecrets.secrets.database.valueIsJson`              | Set this to true if Database Secrets are created as Key-Value Pair.                                                                                                                                                                                                                                                                                                 |  `false`                                                                                                                |
...
| `externalsecrets.secrets.admin.valueIsJson`                 | Set this to true if Admin Secret is created as Key-Value Pair.                                                                                                                                                                                                                                                   |  `false`                                                                                                                   |
...
| `externalsecrets.secrets.license.licenseKey`                | Set this to the name of the key in the secret which contains nexus license                                                                                                    |                                                                                                                     |
| `externalsecrets.secrets.license.valueIsJson`               | Set this to true if License Secret is created as Key-Value Pair, specially when using HashiCorp Vault                                                                                                   |    `false`                                                                                                                 |
