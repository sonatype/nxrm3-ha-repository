...
| `statefulset.priorityClassName`                              | The name of the PriorityClass to assign to Nexus Repository pods. If not set, no priority class will be applied.                                                                                                                                            | `""`                                                                                                              |
| `statefulset.replicaCount`                                  | The desired number of Nexus Repository pods                                                                                                                                                                                                                                                                                                                                      | 3                                                                                                                   |
# Example: Assign a PriorityClass to Nexus Repository pods
...
```bash
helm install nxrm sonatype/nxrm-ha \
  --set statefulset.priorityClassName=critical-priority \
  -f values.yaml
```
