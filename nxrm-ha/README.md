...
* [External secret operator](https://external-secrets.io/latest/): recommended as it supports several external secret stores (AWS, Azure, GCP etc).
  * Irrespective of whether you're installing on AWS/Azure, the following steps are needed to configure the nxrm-ha helm chart to use the External Secrets Operator:
    ...
    - Ensure the cluster has the current `external-secrets.io/v1` CRDs installed. The `eso-*` templates in this chart now render `ExternalSecret` and `SecretStore` resources with `apiVersion: external-secrets.io/v1`.
...
| `statefulset.outboundLogContainer.image.repository`         | Image registry URL for a container which tails Nexus Repository's outbound request log                                                                                                                                                                                                                                                                                           | busybox                                                                                                             |
| `statefulset.outboundLogContainer.image.tag`                | Image tag for a container which tails Nexus Repository's outbound request log                                                                                                                                                                                                                                                                                                    | 1.33.1                                                                                                              |
| `statefulset.outboundLogContainer.resources.requests.cpu`   | The minimum cpu the outbound log container can request                                                                                                                                                                                                                                                                                                                           | 0.1                                                                                                                 |
| `statefulset.outboundLogContainer.resources.requests.memory`| The minimum memory the outbound log container can request                                                                                                                                                                                                                                                                                                                        | 256Mi                                                                                                               |
| `statefulset.outboundLogContainer.resources.limits.cpu`     | The maximum cpu the outbound log container may get.                                                                                                                                                                                                                                                                                                                              | 0.2                                                                                                                 |
| `statefulset.outboundLogContainer.resources.limits.memory`  | The maximum memory the outbound log container may get.                                                                                                                                                                                                                                                                                                                           | 512Mi                                                                                                               |
| `statefulset.jvmLogContainer.image.repository`              | Image registry URL for a container which tails Nexus Repository's JVM diagnostic log                                                                                                                                                                                                                                                                                             | busybox                                                                                                             |
| `statefulset.jvmLogContainer.image.tag`                     | Image tag for a container which tails Nexus Repository's JVM diagnostic log                                                                                                                                                                                                                                                                                                      | 1.33.1                                                                                                              |
| `statefulset.jvmLogContainer.resources.requests.cpu`        | The minimum cpu the JVM log container can request                                                                                                                                                                                                                                                                                                                                | 0.1                                                                                                                 |
| `statefulset.jvmLogContainer.resources.requests.memory`     | The minimum memory the JVM log container can request                                                                                                                                                                                                                                                                                                                             | 256Mi                                                                                                               |
| `statefulset.jvmLogContainer.resources.limits.cpu`          | The maximum cpu the JVM log container may get.                                                                                                                                                                                                                                                                                                                                   | 0.2                                                                                                                 |
| `statefulset.jvmLogContainer.resources.limits.memory`       | The maximum memory the JVM log container may get.                                                                                                                                                                                                                                                                                                                                | 512Mi                                                                                                               |
...
| `service.nexus.targetPort`                                  | The port to forward requests to                                                                                                                                                                                                                                                                                                                                                  | `8081`                                                                                                              |
 | `externalsecrets.enabled`                                   | Set this to true if https://external-secrets.io/latest/ is installed in your Kubernetes cluster and you would like to use it for providing needed secrets to your Nexus Repository pods. The chart's `eso-*` templates target the current `external-secrets.io/v1` CRDs.                                                                                                         |                                                                                                                     |
